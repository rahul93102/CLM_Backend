...
# This script verifies the complete password reset flow:
# 1. Register user (receives OTP)
# 2. Login with original password
# 3. Request password reset (OTP sent)
# 4. Verify OTP is received
# 5. Reset password with valid OTP
# 6. Login with new password to confirm reset worked
